...
/* Put the tokens into the symbol table, so that GDB and other debuggers
   know about them.  */
enum yytokentype { LABEL = 258, VINSTR = 259, IMM = 260 };
#endif
...
/* YYPRHS[YYN] -- Index of the first RHS symbol of rule number YYN in
   YYRHS.  */
static const yytype_uint8 yyprhs[] = {0, 0, 3, 5, 8, 11, 12, 14, 17, 20};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] = {7, 0,  -1, 3, -1, 7, 3, -1, 7, 8, -1, -1,
                                    4, -1, 4,  5, -1, 8, 4, -1, 8, 4, 5,  -1};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] = {0, 22, 22, 23, 24, 25, 29, 30, 31, 32};
#endif
...
static const char* const yytname[] = {
    "$end", "error",   "$undefined", "LABEL",   "VINSTR",
    "IMM",  "$accept", "PROGRAM",    "VINSTRS", YY_NULL};
#endif
...
static const yytype_uint8 yyr1[] = {0, 6, 7, 7, 7, 7, 8, 8, 8, 8};

/* YYR2[YYN] -- Number of symbols composing right hand side of rule YYN.  */
static const yytype_uint8 yyr2[] = {0, 2, 1, 2, 2, 0, 1, 2, 2, 3};

/* YYDEFACT[STATE-NAME] -- Default reduction number in state STATE-NUM.
   Performed when YYTABLE doesn't specify something else to do.  Zero
   means the default is an error.  */
static const yytype_uint8 yydefact[] = {5, 2, 0, 1, 3, 6, 4, 7, 8, 9};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {-1, 2, 6};

/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
#define YYPACT_NINF -4
static const yytype_int8 yypact[] = {-2, -4, 0, -4, -4, -3, 1, -4, 2, -4};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] = {-4, -4, -4};

/* YYTABLE[YYPACT[STATE-NUM]].  What to do in state STATE-NUM.  If
   positive, shift that token.  If negative, reduce the rule which
   number is the opposite.  If YYTABLE_NINF, syntax error.  */
#define YYTABLE_NINF -1
static const yytype_uint8 yytable[] = {3, 1, 7, 4, 5, 8, 0, 9};

#define yypact_value_is_default(Yystate) (!!((Yystate) == (-4)))

#define yytable_value_is_error(Yytable_value) YYID(0)

static const yytype_int8 yycheck[] = {0, 3, 5, 3, 4, 4, -1, 5};

/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
   symbol of state STATE-NUM.  */
static const yytype_uint8 yystos[] = {0, 3, 7, 0, 3, 4, 8, 5, 4, 5};
...
#line 30 "parser.y"
    {
      parse_t::get_instance()->add_vinstr((yyvsp[(1) - (2)].vinstr_name),
                                          (yyvsp[(2) - (2)].imm_val));
    } break;
...
#line 32 "parser.y"
    {
      parse_t::get_instance()->add_vinstr((yyvsp[(2) - (3)].vinstr_name),
                                          (yyvsp[(3) - (3)].imm_val));
    } break;
